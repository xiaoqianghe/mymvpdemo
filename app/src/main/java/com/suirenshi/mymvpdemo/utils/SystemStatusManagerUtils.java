...
public class SystemStatusManagerUtils {
    /**
    ...
    public void setTranslucentStatus(int res) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            SystemStatusManagerUtils tintManager = new SystemStatusManagerUtils(this.mContext);
     ...
     */
    @TargetApi(19)
    public SystemStatusManagerUtils(Activity activity) {
